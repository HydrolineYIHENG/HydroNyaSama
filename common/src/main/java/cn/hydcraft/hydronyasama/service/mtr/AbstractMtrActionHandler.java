...
abstract class AbstractMtrActionHandler implements cn.hydcraft.hydronyasama.service.BeaconActionHandler {
    ...
    @Override
    public abstract BeaconResponse handle(BeaconMessage message, cn.hydcraft.hydronyasama.transport.TransportContext context);
}
