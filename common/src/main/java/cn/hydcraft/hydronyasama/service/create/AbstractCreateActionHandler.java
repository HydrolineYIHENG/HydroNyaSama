...
abstract class AbstractCreateActionHandler implements cn.hydcraft.hydronyasama.service.BeaconActionHandler {
    ...
    @Override
    public abstract BeaconResponse handle(cn.hydcraft.hydronyasama.protocol.BeaconMessage message,
